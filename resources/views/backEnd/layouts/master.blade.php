...
<html lang="en">
  <head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{imgUrl(isset($generalsetting->favicon) ? $generalsetting->favicon : 'backEnd/assets/images/favicon.ico')}}" />
        ...
        <div class="container-fluid">
          <ul class="list-unstyled topnav-menu float-end mb-0">
                ...
                <div class="noti-scroll" data-simplebar>
                  ...
                  <a href="{{route('admin.orders',['slug'=>'pending'])}}" class="dropdown-item notify-item active">
                    <div class="notify-icon">
                      <img src="{{imgUrl($porder->customer?$porder->customer->image:'')}}" class="img-fluid rounded-circle" alt="" />
                    </div>
            ...
            <li class="dropdown notification-list topbar-dropdown">
              <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <img src="{{imgUrl(Auth::guard('admin')->user()->image)}}" alt="user-image" class="rounded-circle" />
          ...
          <div class="logo-box">
            <a href="{{url('admin/dashboard')}}" class="logo logo-dark text-center">
              <span class="logo-sm">
                <img src="{{imgUrl(isset($generalsetting->white_logo) ? $generalsetting->white_logo : 'backEnd/assets/images/logo.png')}}" alt="" height="50" />
