                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-light rounded border border-light">
                            ...
                            <div>
                                <input type="hidden" name="status" id="status_hidden" value="{{ $blog->status }}">
                                <label class="switch">
                                    <input type="checkbox" id="status_toggle" {{ $blog->status == 1 ? 'checked' : '' }} onchange="document.getElementById('status_hidden').value = this.checked ? 1 : 0">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="image-upload-box" onclick="document.getElementById('image').click()">
                            ...
                            @if($blog->image)
                                <img id="preview_image" class="preview-img" src="{{ imgUrl($blog->image) }}" alt="Blog Image" style="display: block;">
