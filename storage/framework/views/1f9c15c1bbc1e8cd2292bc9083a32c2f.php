...
<head>
    ...
    <style>
        :root {
            --brand-primary: <?php echo e($generalsetting->primary_color ?? '#0f8f7a'); ?>;
            --brand-secondary: <?php echo e($generalsetting->secodery_color ?? '#ff8a00'); ?>;
            --ink: #172033;
            --muted: #6b7280;
            --line: #e5e7eb;
            --surface: #ffffff;
        ...
        * {
        ...
        .login-visual {
            ...
            background-image:
                ...
                url("<?php echo e(asset('uploads/petshop/banners/pet-shop-ai-store.png')); ?>");
            ...
            <div class="login-panel">
                <div class="login-card">
                    <div class="brand-block">
                        ...
                        <p class="login-subtitle">Login to continue to <?php echo e($generalsetting->name); ?> admin dashboard.</p>
                    </div>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="admin@example.com">
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="password" required placeholder="Enter your password">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <label class="remember-label" for="checkbox-signin">
                                <input type="checkbox" name="remember" id="checkbox-signin" value="1" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                <span>Remember me</span>
                            </label>
                            <a href="<?php echo e(route('admin.password.request')); ?>" class="forgot-link">Forgot password?</a>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\petvalu\resources\views/backEnd/auth/login.blade.php ENDPATH**/ ?>